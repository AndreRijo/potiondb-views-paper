...
We identify two types of values: base objects, \emph{Objs}, and derived objects, \emph{Views}.
We define the set of objects of a database, \emph{DB}, as \emph{DB} = \emph{Objs U Views}.
Informally, we classify as an object (\emph{o}) any value that is either a base object (\emph{b}) or view (\emph{v}).
We distinguish between base objects and views whenever necessary for clarity.

The value of a view is defined as a function of the values of other object(s), i.e., $\forall v \in Views, v = fun$
