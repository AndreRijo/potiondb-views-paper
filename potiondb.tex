...
specifying view, a vie that includes two \qcr{GROUP BY} clauses will lead to multiple object,
one for each value of the second clause. 
In the example of the top sales presented in Figure~\ref{fig:viewtopsales}, one top-K counter
object will be created (as needed) for each month of the year, and its PotionDB key will include
