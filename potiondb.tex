...
\begin{algorithm}
	\begin{algorithmic}[1]
		...
		\Statex prep$_i$: \code{heap}$\langle$TS$\rangle$ \Comment{list of (sorted) prepared timestamps\carla{or transactions}}
		\Statex hold$_i$: \code{heap}$\langle$tID$\times$TC$\times$TC$\rangle$ \Comment{commits on hold (txId, rc, cc)} 
