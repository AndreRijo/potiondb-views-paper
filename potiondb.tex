...
Many existing web services of global scale have stright latency, availability and fault tolerance requirements.
To handle this, some services distribute their datacenters accross the globe, with users accessing the closest datacenter.
...
We leverage on existing partial and non-uniform replication algorithms to provide materialized views of data that may be split accross multiple servers.
