...
\begin{figure}
	\centering
	\includegraphics[width=0.64\linewidth]{singleQuery/upd_rate_noTC_global_vs_local}
	\vspace*{-0.65em}
...
In these experiments, we used PostgreSQL's incremental view maintenance extension \cite{ivm}. 
...
use a single server, with all operations being propagated to this server. Thus, we focus on comparing PostgreSQL with \emph{Single}.
...
%	\caption{Postgres vs PotionDB. P, S and PG stand for, respectively, PotionDB, \emph{Single} and Postgres. All represents all selected queries;  Sub consists of Q3, Q5, Q14 and Q18.}
	...
	\begin{minipage}{.36\linewidth}
		...
		\caption{PostgreSQL query performance with indexes instead of views}
		\label{fig:postgresNoViews}
	\end{minipage}
\end{figure*}
