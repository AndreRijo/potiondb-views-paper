...
First,  top-K objects,  instead of keeping only the value associated with an element,  keep multiple
attributes, as needed for storing the attributes of a view entry.
