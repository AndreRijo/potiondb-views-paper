...
\textls[-25]{We say that an operation $o_a$
...
The throughput difference between Top-1 and Top-10 is small (10\%). This happens as on both the amount of data transfered is small compared to the communication overhead (latency + metadata transfered), as well as PotionDB handling a high amount of clients.
