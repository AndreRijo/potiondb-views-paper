...
\begin{algorithm}
	\begin{algorithmic}[1]
		...
		\If{$\mathit{rr \leq vc_G}$}	\label{alg_line:remoteCheck}
...
\begin{figure}
	\centering
	\includegraphics[width=.8\linewidth]{updRate_global_cut}
...
\begin{figure}
	...
	\caption{Normal(P\_) and Local (L\_) PotionDB's performance with varying update rate, with latency added.}
