...
Figure \ref{fig:viewtopsales} shows the specification of a view that maintains the top 10 products with the most profit in sales for
...
by PotionDB), a replica knows that no anomaly can occur if the operation has been seen in all replicas of the object, 
...
Finally,  some views are supported by top-K objects. Figure~\ref{fig:q18_view} presents the view to 
