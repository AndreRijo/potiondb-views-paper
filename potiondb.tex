...
Doing this extension is straightforward for all NuCRDTs we have defined, besides the top-K counter. 
...
\begin{figure}
	...
	\vspace*{-0.65em}
	\caption{\textbf{P}otionDB and \textbf{L}ocal PotionDB's performance with multiple update rates, without added latency.}
...
Casual consistency is a weak consistency model that alleviates this problem, however anomalies can still be observed even with cross-object causality \cite{cops, burckhardt2013understanding}.
...
PotionDB's key feature is the provision of automatically maintained materialized views that are always consistent with their base data and can efficiently answer complex queries regarding large amounts of global data with a single read operation, even if the base data is partitioned across faraway data centers.
