...
Geo-replication is a key technique used by global services to provide low latency and high
availability to users. As the number of data centers increase, so does the replication cost of full replication, which 
...
For supporting global services running at multiple geographic locations, it is necessary 
