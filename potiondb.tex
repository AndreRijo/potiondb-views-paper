...
We evaluated PotionDb with \mbox{TPC-H} queries~\cite{tpch} and micro-benchmarks.
The results show that PotionDB provides much better performance to answer recurrent queries
than alternative approaches.  Performance scales almost linearly with the number of replicas in the system.
Furthermore, the overhead of maintaining materialized views is low, increasing slightly with
the ratio of updates. 
