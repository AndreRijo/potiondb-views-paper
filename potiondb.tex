...
\andre{TODO: I don't actually have any results that demonstrate this}
...
Since $\mathit{pc}$ is monotonically increasing, all shards in $W_T$ will return different values and no two transactions in $S_j$ will have a proposed value in common.
...
A client receives a confirmation of transaction committed, along with $T\!.\mathit{cc}$, when all shards in $W_T$ send the committed message.
